...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final HaroldadminLibraryAccessors laccForHaroldadminLibraryAccessors = new HaroldadminLibraryAccessors(owner);
    ...
    private final ZeloryLibraryAccessors laccForZeloryLibraryAccessors = new ZeloryLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>ok2curl</b> with <b>com.github.mrmike:ok2curl</b> coordinates and
     * with version reference <b>ok2curl</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getOk2curl() {
        return create("ok2curl");
    }
    ...
    /**
     * Group of libraries at <b>haroldadmin</b>
     */
    public HaroldadminLibraryAccessors getHaroldadmin() {
        return laccForHaroldadminLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>zelory</b>
     */
    public ZeloryLibraryAccessors getZelory() {
        return laccForZeloryLibraryAccessors;
    }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>composeShimmer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class GoogleAccompanistPagerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>accompanist.pager</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
         ...
         * with version reference <b>accompanist.pager.indicators</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class HaroldadminLibraryAccessors extends SubDependencyFactory {

        public HaroldadminLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>networkresponseadapter</b> with <b>com.github.haroldadmin:NetworkResponseAdapter</b> coordinates and
         * with version reference <b>networkresponseadapter</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNetworkresponseadapter() {
            return create("haroldadmin.networkresponseadapter");
        }
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>okhttp.urlconnection</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class PlayServicesMlkitLibraryAccessors extends SubDependencyFactory {
        private final PlayServicesMlkitDocumentLibraryAccessors laccForPlayServicesMlkitDocumentLibraryAccessors = new PlayServicesMlkitDocumentLibraryAccessors(owner);

        public PlayServicesMlkitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>play.services.mlkit.document</b>
         */
        public PlayServicesMlkitDocumentLibraryAccessors getDocument() {
            return laccForPlayServicesMlkitDocumentLibraryAccessors;
        }

    }

    public static class PlayServicesMlkitDocumentLibraryAccessors extends SubDependencyFactory {

        public PlayServicesMlkitDocumentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>scanner</b> with <b>com.google.android.gms:play-services-mlkit-document-scanner</b> coordinates and
         * with version reference <b>playServicesMlkitDocumentScanner</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getScanner() {
            return create("play.services.mlkit.document.scanner");
        }
    ...
    public static class ProtobufKotlinLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>protobufKotlinLite</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>retrofit.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
    ...
    public static class RoomLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>room.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ZeloryLibraryAccessors extends SubDependencyFactory {

        public ZeloryLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompressor() {
            return create("zelory.compressor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanistPermissions</b> with value <b>0.25.1</b>
         * <p>
        ...
        /**
         * Version alias <b>composeShimmer</b> with value <b>1.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseConfigKtx</b> with value <b>22.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3Exoplayer</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3ExoplayerHls</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>media3Ui</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>networkresponseadapter</b> with value <b>4.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNetworkresponseadapter() { return getVersion("networkresponseadapter"); }

        /**
         * Version alias <b>ok2curl</b> with value <b>0.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOk2curl() { return getVersion("ok2curl"); }

        /**
         * Version alias <b>playServicesMlkitDocumentScanner</b> with value <b>16.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesMlkitDocumentScanner() { return getVersion("playServicesMlkitDocumentScanner"); }
        ...
        /**
         * Version alias <b>protobufJavalite</b> with value <b>3.23.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>protobufKotlinLite</b> with value <b>3.23.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getProtobufKotlinLite() { return getVersion("protobufKotlinLite"); }
        ...
        /**
         * Version alias <b>workRuntimeKtx</b> with value <b>2.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AccompanistVersionAccessors extends VersionFactory  {
        ...
        private final AccompanistPagerVersionAccessors vaccForAccompanistPagerVersionAccessors = new AccompanistPagerVersionAccessors(providers, config);
        public AccompanistVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.accompanist.pager</b>
         */
        public AccompanistPagerVersionAccessors getPager() {
            return vaccForAccompanistPagerVersionAccessors;
        }

    }

    public static class AccompanistPagerVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public AccompanistPagerVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>accompanist.pager</b> with value <b>0.28.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("accompanist.pager"); }

        /**
         * Version alias <b>accompanist.pager.indicators</b> with value <b>0.28.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIndicators() { return getVersion("accompanist.pager.indicators"); }
    ...
    public static class OkhttpVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("okhttp"); }

        /**
         * Version alias <b>okhttp.urlconnection</b> with value <b>4.9.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUrlconnection() { return getVersion("okhttp.urlconnection"); }
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>retrofit.version</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RoomVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>room.version</b> with value <b>2.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
